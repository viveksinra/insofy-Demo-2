                                ...
                                <div className="col-xl-2 col-lg-12 col-md-5 col-sm-5 col-xs-5">
                                    <div className="logobox">
                                        <Link href="/" className="logo navbar-brand">
                                            <img src="/assets/images/theme-logo.png" alt="Insofy" className="logo_default" />
                                        </Link>
                                    </div>
                                </div>
                                <div className="col-xl-10 col-lg-9 col-md-7 col-sm-7 col-xs-7 column_menu">
                                    <div className="navbar_content d-flex align-items-center justify-content-end">
                                        <NavbarNav />
                                        {/* <div className="search search-toggler" onClick={handleSearch}>
                                            <i className="fi-rs-search" />
                                        </div> */}
                                        {/* <div className="button" style={{marginLeft:"15px"}}>
