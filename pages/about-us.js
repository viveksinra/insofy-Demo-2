                                ...
                                <div className="row">
                                    <div className="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                        <div className="iamge mr_bottom_20 mr_top_20">
                                            <img src="/assets/images/client/clientimg1.png" className="img-fluid m-auto" alt="client" />
                                        </div>
                                    </div>
                                    <div className="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                        <div className="iamge mr_bottom_20 mr_top_20">
                                            <img src="/assets/images/client/clientimg2.png" className="img-fluid m-auto" alt="client" />
                                        </div>
                                    </div>
                                    <div className="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                        <div className="iamge mr_bottom_20 mr_top_20">
                                            <img src="/assets/images/client/clientimg3.png" className="img-fluid m-auto" alt="client" />
                                        </div>
                                    </div>
                                    <div className="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                        <div className="iamge mr_bottom_20 mr_top_20">
                                            <img src="/assets/images/client/clientimg4.png" className="img-fluid m-auto" alt="client" />
                                        </div>
                                    </div>
                                    <div className="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                        <div className="iamge mr_bottom_20 mr_top_20">
                                            <img src="/assets/images/client/clientimg5.png" className="img-fluid m-auto" alt="client" />
                                        </div>
                                    </div>
                                    <div className="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                                        <div className="iamge mr_bottom_20 mr_top_20">
                                            <img src="/assets/images/client/clientimg6.png" className="img-fluid m-auto" alt="client" />
                                        </div>
                                    </div>
                                </div>
                            </div>
